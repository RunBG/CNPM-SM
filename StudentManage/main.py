...
from flask import request, flash, json, jsonify, url_for
...
@app.route('/manage/student/delete/<int:student_id>', methods=['POST'])
def delete_student(student_id):
    if current_user.is_authenticated and current_user.admin == 1:
        ...
        if student_to_delete:
            ...
            flash('Không tìm thấy sinh viên để xóa.')
